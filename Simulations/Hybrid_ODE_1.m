...
% EoM
dydt(1) = y(2);
dydt(2) = y(3)^2/y(1) - mu_e/y(1)^2 - mu_m*(y(1) + D*cos(y(4)))/r_msc^3 + mu_m*cos(y(4))/D^2 + a_T*sin(u) + 2*omg*y(3) + omg^2*y(1);
dydt(3) = mu_m*D*sin(y(4))/r_msc^3 - mu_m*sin(y(4))/D^2 + a_T*cos(u) - 2*omg*y(2) - y(2)*y(3)/y(1);
dydt(4) = y(3)/y(1);

% Costate 
dydt(5) = y(6)*(y(3)^2/y(1)^2 + mu_m/r_msc^3 - 3*mu_m*(y(1) + D*cos(y(4)))^2/r_msc^5 - 2*mu_e/y(1)^3 - omg^2) + y(7)*(-y(2)*y(3)/y(1)^2 + 3*mu_m*(y(1) + D*cos(y(4)))*D*sin(y(4))/r_msc^5) + y(8)*y(3)/y(1)^2;
dydt(6) = -y(5) + y(7)*(y(3)/y(1) + 2*omg); 
dydt(7) = y(6)*(-2*omg - 2*y(3)/y(1)) + y(7)*y(2)/y(1) - y(8)/y(1);
dydt(8) = y(6)*(-mu_m*D*sin(y(4))/r_msc^3 + 3*mu_m*(y(1) + D*cos(y(4)))*D*y(1)*sin(y(4))/r_msc^5 + mu_m*sin(y(4))/D^2) + y(7)*(-mu_m*D*cos(y(4))/r_msc^3 - 3*mu_m*D^2*y(1)*(sin(y(4)))^2/r_msc^5 + mu_m*cos(y(4))/D^2);
